-- Script completo para configurar o banco de dados Super Beast Team Building
...
-- 3. Funções para manter estatísticas atualizadas
...
-- Inserir algumas imagens de exemplo na galeria
...
-- 6. Configurar políticas de segurança (RLS - Row Level Security)
...
-- Políticas para a tabela de planos (leitura pública, escrita apenas para admins)
...
-- Políticas para a tabela de galeria (leitura pública, escrita apenas para admins)
...
-- Políticas para estatísticas (leitura pública limitada, escrita apenas para admins)
